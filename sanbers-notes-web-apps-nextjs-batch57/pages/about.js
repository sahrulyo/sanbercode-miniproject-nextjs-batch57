...
const About =() => {
  ...
  <section className="bg-white dark:bg-gray-900">
        <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
          <img className="w-full dark:hidden" src="https://img.freepik.com/premium-photo/3d-man-casual-work-from-home-technology-communicat_1255023-21183.jpg?w=1800" alt="dashboard image" />
          ...
          <div className="mt-4 md:mt-0">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">This is a blog for developer and software engineer discussion about the latest trend framework</h2>
            <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">Designed to helps you connect with friends and communities of people who share your interests. Connecting with your friends and family as well as discovering new ones is easy with features like Groups.</p>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Designed for dynamic teams developer like a monsters</h2>
            <p className="text-gray-500 sm:text-xl dark:text-gray-400">Designed focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
          </div>
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Developer</h3>
            ...
            <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Software Engineer</h3>
            ...
            <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Project Manager</h3>
            ...
            <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Prompt Engineer</h3>
